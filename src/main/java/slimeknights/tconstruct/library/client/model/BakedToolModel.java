...
public class BakedToolModel extends BakedWrapper.Perspective {
	...
	/**
	 * The length of brokenParts has to match the length of parts. If a part does
	 * not have a broken texture, the entry in the array simply is null.
	 */
	...
	protected static class ToolItemOverrideList extends ItemOverrideList {
		...
		@Nonnull
		@Override
		public IBakedModel handleItemState(@Nonnull IBakedModel originalModel, final ItemStack stack, final World world,
		...
		protected CacheKey getCacheKey(ItemStack stack, BakedToolModel original, World world,
				EntityLivingBase entityLivingBase) {
			return new CacheKey(original, stack);
		}

		protected IBakedModel getCompleteModel(ItemStack stack, World world, EntityLivingBase entity,
				BakedToolModel original) {
		...
		private BakedToolModel getBaseModel(@Nonnull BakedToolModel originalModel, ItemStack stack, World world,
		...
		private void addModifierQuads(ItemStack stack, BakedToolModel original,
				ImmutableList.Builder<BakedQuad> quads) {
		...
		protected void addExtraQuads(ItemStack stack, BakedToolModel original, ImmutableList.Builder<BakedQuad> quads,
	...
	private static class BakedSimpleForTools extends BakedSimple {

		public BakedSimpleForTools(ImmutableList<BakedQuad> quads,
				ImmutableMap<TransformType, TRSRTransformation> transforms, IBakedModel base) {
			super(quads, transforms, base);
		}

		public BakedSimpleForTools(List<BakedQuad> quads, ImmutableMap<TransformType, TRSRTransformation> transforms,
				IBakedModel base) {
			super(quads, transforms, base);
		}

		public BakedSimpleForTools(List<BakedQuad> quads, ImmutableMap<TransformType, TRSRTransformation> transforms,
				TextureAtlasSprite particle, boolean ambientOcclusion, boolean isGui3d, ItemOverrideList overrides) {
