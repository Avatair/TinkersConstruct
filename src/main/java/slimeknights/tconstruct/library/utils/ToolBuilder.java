...
public final class ToolBuilder {
	 ...
	 *
	 * @param rootCompound
	 *            The root compound of the item
	 * @param trait
	 *            The trait to add.
	 * @param color
	 *            The color used on the tooltip. Will not be used if the trait
	 *            already exists on the tool.
	 */
	 ...
	 *
	 * @param input
	 *            Items to modify the tool with
	 * @param toolStack
	 *            The tool
	 * @param removeItems
	 *            If true the applied items will be removed from the array
	 * @return The modified tool or null if something went wrong or no modifier
	 *         applied.
	 * @throws TinkerGuiException
	 *             Thrown when not matching modifiers could be applied. Contains
	 *             extra-information why the process failed.
	 */
	@Nonnull
	 ...
	 *
	 * @param toolStack
	 *            The tool to replace the parts in
	 * @param toolPartsIn
	 *            The toolparts.
	 * @param performAction
	 *            If true the applied items will be removed from the array
	 ...
	 *
	 * @param pattern
	 *            Input-pattern. Has to be a Pattern.
	 * @param materialItems
	 *            The Itemstacks to craft the item out of
	 * @param removeItems
	 *            If true the match will be removed from the passed items
	 ...
	 *
	 * @param rootNBT
	 *            The root NBT tag compound of the tool to to rebuild. The NBT will
	 *            be modified, overwriting old data.
	 */
