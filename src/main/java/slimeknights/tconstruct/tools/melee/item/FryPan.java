...
public class FryPan extends TinkerToolCore {
	...
	public void onPlayerStoppedUsing(ItemStack stack, World world, EntityLivingBase player, int timeLeft) {
		...
		if (mop.typeOfHit == RayTraceResult.Type.ENTITY) {
			...
			// bonus damage!
			AttributeModifier modifier = new AttributeModifier(FRYPAN_CHARGE_BONUS, "Frypan charge bonus",
					progress * 5f, 0);
			...
			world.playSound(null, player.getPosition(), Sounds.frypan_boing, SoundCategory.PLAYERS, 1.5f,
					0.6f + 0.2f * TConstruct.random.nextFloat());
