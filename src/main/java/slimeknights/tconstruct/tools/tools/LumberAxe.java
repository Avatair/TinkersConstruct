...
public class LumberAxe extends AoeToolCore {
	...
	public static final ImmutableSet<net.minecraft.block.material.Material> effective_materials = ImmutableSet.of(
			net.minecraft.block.material.Material.WOOD, net.minecraft.block.material.Material.GOURD,
	...
	public LumberAxe() {
		super(PartMaterialType.handle(TinkerTools.toughToolRod), PartMaterialType.head(TinkerTools.broadAxeHead),
				PartMaterialType.extra(TinkerTools.toughBinding), PartMaterialType.head(TinkerTools.largePlate));

		// lumberaxe is not a weapon. it's for lumberjacks. Lumberjacks are manly,
		// they're weapons themselves.
	...
	public boolean onBlockStartBreak(ItemStack itemstack, BlockPos pos, EntityPlayer player) {
		if (!ToolHelper.isBroken(itemstack)
				&& ToolHelper.isToolEffective2(itemstack, player.getEntityWorld().getBlockState(pos))
				&& detectTree(player.getEntityWorld(), pos)) {
	...
	public static boolean fellTree(ItemStack itemstack, BlockPos start, EntityPlayer player) {
		...
		TinkerToolEvent.ExtraBlockBreak event = TinkerToolEvent.ExtraBlockBreak.fireEvent(itemstack, player,
