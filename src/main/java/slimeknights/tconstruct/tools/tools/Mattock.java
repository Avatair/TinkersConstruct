...
public class Mattock extends AoeToolCore {
	...
	public static final ImmutableSet<net.minecraft.block.material.Material> effective_materials_axe = ImmutableSet.of(
			net.minecraft.block.material.Material.WOOD, net.minecraft.block.material.Material.CACTUS,
	...
	public static final ImmutableSet<net.minecraft.block.material.Material> effective_materials_shovel = ImmutableSet
			.of(net.minecraft.block.material.Material.GRASS, net.minecraft.block.material.Material.GROUND,
					net.minecraft.block.material.Material.CLAY);

	public Mattock() {
		super(PartMaterialType.handle(TinkerTools.toolRod), PartMaterialType.head(TinkerTools.axeHead),
	...
	public boolean isEffective(IBlockState state) {
		return effective_materials_axe.contains(state.getMaterial())
				|| effective_materials_shovel.contains(state.getMaterial());
	}
...
//		return new int[] { 1, 2 };
	...
	private EnumActionResult useHoe(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos blockPos,
	...
	public List<String> getInformation(ItemStack stack, boolean detailed) {
		...
		info.add(String.format("%s: %s", text, HarvestLevels.getHarvestLevelName(getAxeLevel(stack)))
				+ TextFormatting.RESET);

		// special shovel harvest level
		text = Util.translate("stat.mattock.shovellevel.name");
		info.add(String.format("%s: %s", text, HarvestLevels.getHarvestLevelName(getShovelLevel(stack)))
				+ TextFormatting.RESET);
